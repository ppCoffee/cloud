...
public class PaymentServiceImpl {
    ...
    public String payment_timeout_handler(Integer id) {
    	int timeNumber = 3;
    	return "线程池："+Thread.currentThread().getName()+"   paymentInfo_TimeOut,id：  "+id+"\t"+"兜底的handler"+" 耗时(秒)"+timeNumber;
    }
    ...
    @HystrixCommand(fallbackMethod = "paymentCircuitBreaker_fallback",commandProperties = {
            ...
            @HystrixProperty(name = "circuitBreaker.errorThresholdPercentage",value = "60"), //失败率达到多少后跳闸 例子为60%
    })
